...
public final class ApiResPacket implements Externalizable, Message<ApiResPacket>, Schema<ApiResPacket>
{

    public static Schema<ApiResPacket> getSchema()
    {
        return DEFAULT_INSTANCE;
    }

    public static ApiResPacket getDefaultInstance()
    {
        return DEFAULT_INSTANCE;
    }

    static final ApiResPacket DEFAULT_INSTANCE = new ApiResPacket();
    ...
    public Schema<ApiResPacket> cachedSchema()
    {
        return this;
    }
    ...
    public ApiResPacket newMessage()
    {
        return new ApiResPacket();
    }

    public Class<ApiResPacket> typeClass()
    {
        return ApiResPacket.class;
    }

    public String messageName()
    {
        return ApiResPacket.class.getSimpleName();
    }

    public String messageFullName()
    {
        return ApiResPacket.class.getName();
    }

    public boolean isInitialized(ApiResPacket message)
    {
        return 
            message.reqNum != null 
    ...
    public void mergeFrom(Input input, ApiResPacket message) throws IOException
    {
    ...
    public void writeTo(Output output, ApiResPacket message) throws IOException
    {
