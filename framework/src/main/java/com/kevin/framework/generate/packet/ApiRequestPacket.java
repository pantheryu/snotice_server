...
public final class ApiRequestPacket implements Externalizable, Message<ApiRequestPacket>, Schema<ApiRequestPacket>
{
    ...
    public boolean isInitialized(ApiRequestPacket message)
    {
        return true;
    }

    public void mergeFrom(Input input, ApiRequestPacket message) throws IOException
    {
        for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
        {
            switch(number)
            {
                ...
                case 101:
                    ...
                    break;
                case 102:
                    message.signInfo = input.readString();
                    break;
                default:
    ...
    public void writeTo(Output output, ApiRequestPacket message) throws IOException
    {
        if(message.apiCalls != null)
        {
        ...
        if(message.appKey != null)
            output.writeString(101, message.appKey, false);

        if(message.signInfo != null)
            output.writeString(102, message.signInfo, false);
    }
    ...
    public String getFieldName(int number)
    {
        switch(number)
        {
            ...
            case 101: return "appKey";
            case 102: return "signInfo";
            default: return null;
        }
    }
